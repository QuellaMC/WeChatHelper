...
/**
 * Typecho 微信助手
 * 对冰剑(https://github.com/binjoo/WeChatHelper)进行精简再强化的版本。
 *
 * @package WeChatHelper
 * @author 光辉之路MC
 * @version 5.5.5
 * @link https://blog.ghzl.fun
 */
...
(1, 'button', '首页', 'view', 'https://blog.ghzl.fun/', 10, 1, 0, 1503804104),
(3, 'button', '搜索', 'view', 'https://blog.ghzl.fun/', 20, 2, 0, 1503804141),
...
(8, 'sub_button', '手气不错', 'click', 'l', 54, 4, 4, 1503824995);");
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        /** 返回最大结果条数 **/
        $imageDefault = new Typecho_Widget_Helper_Form_Element_Text('imageDefault', NULL, 'https://img.ghzl.fun/imgs/2020/04/c72759ef6113bca5.jpg', _t('默认显示图片'), '图片链接，支持JPG、PNG格式，推荐图为80*80。');
